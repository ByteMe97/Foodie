...
public class MealOptionFour extends Fragment {
    ...
    private MealOptionFour.MealOption4Listener listener;
    private Switch sw4;
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        sw4 = (Switch)view.findViewById(R.id.AddMealOptionFour);
        sw4.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    String input = getString(R.string.meal_option_four_name);
                    listener.onMeal4Chosen(input);
                }
                if (!isChecked) {
                    String meal = getString(R.string.meal_option_four_name);
                    listener.onMeal4Removed(meal);
                }
            }
        });
    }
    ...
    public void onAttach(@NonNull Context context) {
        ...
        if(context instanceof MealOptionFour.MealOption4Listener){
            listener = (MealOptionFour.MealOption4Listener) context;
        }
        else{
            throw new RuntimeException(context.toString() +
                    "must implement MealOption4Listener");
        }
    }
    ...
    public interface MealOption4Listener {
        ...
        void onMeal4Removed(String input);
    }
}