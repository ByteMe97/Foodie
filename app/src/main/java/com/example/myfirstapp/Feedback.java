...
/**
 * Class used to obtain feedback from the user
 */
public class Feedback extends PreferenceFragmentCompat {
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        setPreferencesFromResource(R.xml.feedback_perferences, rootKey);
    }
}
